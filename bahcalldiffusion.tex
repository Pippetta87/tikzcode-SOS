...
\coordinate (coordd) at ([shift={(3,-1)}]current page.north west);
...
\coordinate (coordt) at ([shift={(0,1)}]current page.south east);
...
\coordinate (coordl) at ([shift={(3,1)}]current page.south west);
...
\coordinate (coordh) at ([shift={(0,-1)}]current page.north east);
