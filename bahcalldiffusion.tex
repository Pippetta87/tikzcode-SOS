...
\coordinate (coordd) at ([shift={(0,-10)}]current page.north west);
...
\coordinate (coordt) at ([shift={(-2,2)}]current page.south east);
...
\coordinate (coordl) at ([shift={(-2,2)}]current page.south west);
...
\coordinate (coordh) at ([shift={(-2,-2)}]current page.north east);
