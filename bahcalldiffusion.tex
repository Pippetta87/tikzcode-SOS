...
\begin{axis}[name=temp,at={(0,0)++(225:1cm)},anchor=north west,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=2,
...
\begin{axis}[name=luminosity,at={(0,0)++(-45:1cm)},anchor=north west,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=4,
...
\begin{axis}[name=hydrogen,at={(0,0)++(45:1cm)},anchor=south west,
 y tick label style={
        /pgf/number format/.cd,
            fixed,
            precision=5
