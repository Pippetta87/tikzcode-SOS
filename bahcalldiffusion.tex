...
\begin{tikzpicture}
\begin{axis}[name=density, at={(0,0)++(135:1cm)},anchor=south east,
 y tick label style={
...
\begin{axis}[name=temp,at={($(0,0)++(225:1cm)$)},anchor=north,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=2,
...
\begin{axis}[name=luminosity,at={($(temp.east)+(35,-30)$)},anchor=west,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=4,
