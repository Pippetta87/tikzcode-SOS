...
\begin{axis}[name=density, at={([shift={(2,2)}]current page.north west)},anchor=north west	,
 y tick label style={
...
\begin{axis}[name=hydrogen,at={([shift={(-2,-2)}]current page.north east)},anchor=south west,
 y tick label style={
        /pgf/number format/.cd,
            fixed,
            precision=5
