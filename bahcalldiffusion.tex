...
\begin{axis}[scale only axis,axis y line*=right,ylabel=$\rho(\si{\gram\per\cubic\cm})$,xlabel=$\midfrac{R}{\rsun{}}$,grey]

\addplot gnuplot [raw gnuplot,id=rhoR,no marks,smooth]{set format x "\%8.7f"; plot 'ssm.txt' using 2:4};
\end{axis}
