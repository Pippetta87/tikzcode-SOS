...
\begin{axis}[name=density, at={(0,-10)++(135:5cm)},anchor=south east,
 y tick label style={
...
\begin{axis}[name=temp,at={(0,-10)++(-45:5cm)},anchor=north west,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=2,
...
\begin{axis}[name=luminosity,at={(0,-10)++(-135:5cm)},anchor=north east,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=4,
...
\begin{axis}[name=hydrogen,at={(0,-10)++(45:5cm)},anchor=south west,
 y tick label style={
        /pgf/number format/.cd,
            fixed,
            precision=5
