...
\pgfplotsset{yticklabel style={text width=3em,align=right},every axis plot post/.append style={black},no marks, set decimal separator={,}}

\begin{tikzpicture}
\begin{axis}[name=density, at=(0,0),
 y tick label style={
...
\begin{axis}[name=luminosity,at={($(temp.east)+(25,-30)$)},anchor=west,
 y tick label style={
        /pgf/number format/.cd,
            fixed,
            fixed zerofill,
...
\begin{axis}[name=hydrogen,at={($(luminosity.north)+(25,30)$)},anchor=south,
 y tick label style={
        /pgf/number format/.cd,
            fixed,
            precision=5
