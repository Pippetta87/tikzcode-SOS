...
\tikzset{ every pin/.style={pin edge={black!20!white},draw={black!20!white},rectangle,rounded corners=1pt,font=\tiny,inner sep=1mm}, small dot/.style={fill=black!60!white,circle,scale=0.1} }
...
\clearpage
 ...
 %%plot SSM structure graphs vs m
...
\node[small dot,pin={[pin distance=0.4cm]10:{$X_c=\num{0.3397}$}}] at (axis cs:0,0.3397) {};
...
\begin{scope}[scale=0.50, every node/.style={scale=1.25}]



    \begin{axis}[at=(basegraficoh), anchor=south east,
    restrict x to domain=0.945:1,
      xmin=0.945,xmax=1.0,
      ymin=0.70,ymax=0.75,
    y tick label style={
        /pgf/number format/.cd,
...
\begin{axis}[name=ratioEiEc,
 y tick label style={
  ...
  xlabel=$\midfrac{r}{R_{\odot}}$,
  ylabel=$\midfrac{2u_c}{3KT}$,
yticklabel={\ifdim\tick pt=0pt 0 \else\pgfmathprintnumber{\tick}\fi},
  %ylabel shift = 10mm
  compat=newest
  ]

\addplot gnuplot [raw gnuplot,id=rEiEcratio,no marks,smooth]{plot 'bp2000.dat' using 2:(2*(4.803*10^(-10))^3*(pi*$4/(1.380*10^(-16)*$3))^(0.5)*(6.022*10^(23))^(1.5)*(2*$4*$7+5*$4*$8/4)^(1.5)/(3*$3*1.38*10^(-16)))};
%\node[small dot,pin=-120:{$\lsun{}=\SI{3.844e33}{\erg\per\second}$}] at (axis cs:1,1) {};

\end{axis}


\begin{axis}[name=gamma,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=4,
...
\addplot gnuplot [raw gnuplot,id=gamma,no marks,smooth]{plot 'bp2000.dat' using 2:(((4.803*10^(-10))^2*(1)^2)/(1.380*10^(-16)*$3*()))};
%\node[small dot,pin=-120:{$\lsun{}=\SI{3.844e33}{\erg\per\second}$}] at (axis cs:1,1) {};
...
\clearpage
 ...
 %%plot SSM structure graphs vs r
...
%\draw[color=black] plot[smooth,mark=*,mark size=1pt] file {ssm.txt} node [right] {data};
%\addplot gnuplot [raw gnuplot, id=test, mark=none, color=blue]{plot "test2" using ($1):($4) {ssm.txt}  };
\addplot gnuplot [raw gnuplot,id=RM,no marks,smooth]{set format x "\%8.7f"; plot 'bp2000.dat' using 2:4};
\node[small dot,pin=90:{$\rho_b=\num{1.869e-01}$\si{\gram\per\cubic\cm}}] at (axis cs:0.71377,1.869e-01) {};
\node[small dot,pin=-10:{$\rho_c=\num{1.527e2}$\si{\gram\per\cubic\cm}}] at (axis cs:0,1.527e2) {};
...
\addplot gnuplot [raw gnuplot,id=massT,no marks,smooth]{plot 'bp2000.dat' using 2:3};
\node[small dot,pin=-10:{$T_c=\num{1.5696e7}$}] at (axis cs:0,1.5696e7) {};
\node[small dot,pin={[pin distance=1cm]180:{$T_{cz}=\num{2.18e6}$}}] at (axis cs:0.71377,2.18e6) {};
\node[small dot,pin={[pin distance=1.2cm]95:{$T_{ph}=\SI{5777}{\kelvin}$}}] at (axis cs:1,5777) {};
...
\addplot gnuplot [raw gnuplot,id=massX,no marks,smooth]{plot 'bp2000.dat' using 2:7};
%\node[small dot,pin=-110:{$X_{ph}=\num{0.73507}$}] at (axis cs:1,0.73507) {};
\node[small dot,pin={[pin distance=0.4cm]10:{$X_c=\num{0.3397}$}}] at (axis cs:0,0.3397) {};
...
\addplot gnuplot [raw gnuplot,id=massXzoom,no marks,smooth]{plot 'bp2000.dat' using 2:7};
\node[small dot,pin=-110:{$X_{ph}=\num{0.73936}$}] at (axis cs:1,0.73936) {};
...
\begin{axis}[name=cs,height=0.8\textheight,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=4,
...
\addplot gnuplot [raw gnuplot,id=BP00cs,no marks,smooth]{plot 'bp2000soundspeeds.dat' using 1:2};
%\node[small dot,pin=-120:{$\lsun{}=\SI{3.844e33}{\erg\per\second}$}] at (axis cs:1,1) {};
...
\begin{axis}[name=edensity,height=0.8\textheight,
 y tick label style={
        /pgf/number format/.cd,
            sci,
            precision=4,
...
\addplot gnuplot [raw gnuplot,id=BP00eldensity,no marks,smooth]{plot 'bp2000electrondensity.dat' using 1:2};
%\node[small dot,pin=-120:{$\lsun{}=\SI{3.844e33}{\erg\per\second}$}] at (axis cs:1,1) {};
